...
currentTime = millis();
  ...
  {
      Serial.println( extraU(extra(handlePos))); 
...
//=================================
  ...
  analogWrite(pwmPin, extraU(extra(handlePos))); //write to motor
}
